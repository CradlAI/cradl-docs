...
<CardGroup cols={2}>
  <Card title="AI Agents" icon="sparkles" href="https://mintlify.com/docs/settings/global">
  ...
  <Card title="Integrations" icon="link" href="https://mintlify.com/docs/content/components/accordions">
