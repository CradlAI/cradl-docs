---
title: "Excel"
description: "This document outlines the functionality and characteristics of the Google Sheets Writer node, which enables automated data writing to Google Sheets. "
sidebarTitle: "<Icon icon="flag" iconType="solid" /> The documentation you want, effortlessly."
---

## Overview

The Google Sheets Writer node allows you to write data to Google Sheets from your Cradl AI workflow. It can append new rows, add a single row, or write to specific columns in your spreadsheet.
