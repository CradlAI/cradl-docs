...
<Steps>
  ...
  <Step title="Add the Extract Data From Document action to your Zap">
    ...
    <img
      src="/images/zapier-select-cradl.png"
      alt="Configure the Cradl AI action in Zapier"
      style={{ width:"45%", display: 'inline-block' }}
      />
      
    <img
      src="/images/zapier-setup-step.png"
      alt="Select the Cradl AI app in Zapier"
