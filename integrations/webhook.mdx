...
Check that the computed signature is equal to the one in the X-Cradl-Signature header to ensures the request was sent by us and not altered in transit.