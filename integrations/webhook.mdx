...
3. **Fill in the webhook form**
   ...
   - **URL:** Enter the HTTPS URL for your server endpoint where Cradl AI should send the webhook payload. [**_(Tip: Use webhook.site for quick testing.)_**](http://webhook.site)
