...
description: "Use webhooks to get real-time notifications when key events happen in your Cradl AI workspace."
---
...
3. **Fill in the webhook form**
   ...
   - **URL:** Enter the HTTPS URL for your server endpoint where Cradl AI should send the webhook payload. [___(Tip: Use webhook.site for quick testing.)___](http://webhook.site)
